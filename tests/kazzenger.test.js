...
tap.test('kazzenger function', t => {
  t.test('ok - return correclty', assert => {
    ...
    const expectedResponse = [
      {
        start: moment('2019-12-21T22:00:00.000Z').toDate(),
        end: moment('2019-12-26T22:00:00.000Z').toDate(),
        holidaysCount: 4,
        weekdaysCount: 2,
        daysCount: 6 },
      { start: moment('2019-12-25T22:00:00.000Z').toDate(),
        end: moment('2019-12-29T22:00:00.000Z').toDate(),
        holidaysCount: 4,
        weekdaysCount: 1,
        daysCount: 5 }]
